...
const CreateBill = () => {
  ...
  const {company_address,company_name,company_contact} = userData;
  ...
  const printToFile = async () => {
    let html =  PdfCode(name,Address,Mobile_No,Quantity,Invoice,Product,Total,ReceivedBalance,PaymentType,RemaningBalance,company_name,company_address,
    company_contact);
    ...
    <Screen style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.InputContainer}>
          ...
          <TextInput
            style={styles.textInput}
            onChangeText={(text) => Set_Product(text)}
            value={Product}
